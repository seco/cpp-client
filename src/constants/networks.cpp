...
namespace Devnet
{
	const char nethash[64 + 1] = "578e820911f24e039733b45e4882b73e301f813a0d2c31330dafda84534ffa23";
...
namespace Mainnet
{
	const char nethash[64 + 1] = "6e84d08bd299ed97c212c886c98a57e36545c8f5d645ca7eeae63a8bd62d8988";	
...
const char *randomPeer(ARK::NetworkType netType)
{
	switch (netType) {
		...
		case CUSTOM: return "Error: method not yet available for custom networks"; break;
