...
**************************************************/
std::string ARK::API::V2::Blocks::block(
		const char *const blockId
) {
	char uri[80] = { '\0' };
		strcpy(uri, ARK::API::V2::Paths::Blocks::blocks);
		strcat(uri, "/");
		strcat(uri, blockId);
...
*************************************************/
std::string ARK::API::V2::Blocks::blocks()
{
    char uri[80] = { '\0' };
		strcpy(uri, ARK::API::V2::Paths::Blocks::blocks);
        strcat(uri, "?limit=20&page=1");
    return netConnector.callback(uri);
};
/*************************************************/
...
*************************************************/
std::string ARK::API::V2::Blocks::blocks(const char *const limit, const char *const page)
{
    char uri[80] = { '\0' };
    	strcpy(uri, ARK::API::V2::Paths::Blocks::blocks);
        strcat(uri, "?limit=");
	...
	// strcat(uri, limitBuffer);
    // strcat(uri, "&page=");
    // char pageBuffer[1];
    // sprintf(pageBuffer, "%d", page);
	// strcat(uri, pageBuffer);
    return netConnector.callback(uri);
};
/*************************************************/
