...
* }
**************************************************/
std::string ARK::API::Transactionable::transaction(const char *const id)
{
	char uri[114 + 1] = { '\0' };
...
* }
**************************************************/
std::string ARK::API::Transactionable::transactions()
{
	char uri[69] = { '\0' };
...
* }
**************************************************/
std::string ARK::API::Transactionable::transactionUnconfirmed(const char *const id)
{
	char uri[126 + 1] = { '\0' };
...
* }
**************************************************/
std::string ARK::API::Transactionable::transactionsUnconfirmed()
{
	return netConnector.callback(ARK::API::Paths::Transaction::unconfirmed_s);
}
/*************************************************/
...
**************************************************/
std::string ARK::API::Transactionable::getVendorField(const char *const txID)
{
	char uri[114 + 1] = { '\0' };
		strcpy(uri, ARK::API::Paths::Transaction::getSingle_s);
		strcat(uri, "?id=");
