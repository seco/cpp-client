...
* }
**************************************************/
std::string ARK::API::Delegatable::delegate(
...
* }
**************************************************/
std::string ARK::API::Delegatable::delegates()
{
	char uri[43] = { '\0' };
...
* }
**************************************************/
std::string ARK::API::Delegatable::delegatesCount()
{
	return netConnector.callback(ARK::API::Paths::Delegate::count_s);
};
/*************************************************/
...
* }
**************************************************/
std::string ARK::API::Delegatable::delegateSearch(
...
* }
**************************************************/
std::string ARK::API::Delegatable::delegateVoters(
...
* }
**************************************************/
std::string ARK::API::Delegatable::delegateFee()
{
	return netConnector.callback(ARK::API::Paths::Delegate::fee_s);
};
/*************************************************/
...
* }
**************************************************/
std::string ARK::API::Delegatable::delegateForgedByAccount(
...
* }
**************************************************/
std::string ARK::API::Delegatable::delegateNextForgers()
{
	return netConnector.callback(ARK::API::Paths::Delegate::getNextForgers_s);
};
/*************************************************/
