...
* }
**************************************************/
std::string ARK::API::ONE_Delegates::delegate(
		const char *const parameter
) {
	char uri[120 + 1] = { '\0' };	//max size (pubkey param)
		strcpy(uri, ARK::API::ONE_Paths::ONE_Delegates::get_s);
...
* }
**************************************************/
std::string ARK::API::ONE_Delegates::delegates()
{
	char uri[43] = { '\0' };
		strcpy(uri, ARK::API::ONE_Paths::ONE_Delegates::delegates_s);
	return netConnector.callback(uri);
};
/*************************************************/
...
* }
**************************************************/
std::string ARK::API::ONE_Delegates::delegatesCount()
{
	return netConnector.callback(ARK::API::ONE_Paths::ONE_Delegates::count_s);
};
/*************************************************/
...
* }
**************************************************/
std::string ARK::API::ONE_Delegates::delegateSearch(
		const char *const username
) {
	char uri[69 + 1] = { '\0' };
		strcpy(uri, ARK::API::ONE_Paths::ONE_Delegates::search_s);
		strcat(uri, "?q=");
		strcat(uri, username);
	return netConnector.callback(uri);
};
...
* }
**************************************************/
std::string ARK::API::ONE_Delegates::delegateVoters(
		const char *const publicKey
) {
	char uri[123 + 1] = { '\0' };
		strcpy(uri, ARK::API::ONE_Paths::ONE_Delegates::voters_s);
...
* }
**************************************************/
std::string ARK::API::ONE_Delegates::delegateFee()
{
	return netConnector.callback(ARK::API::ONE_Paths::ONE_Delegates::fee_s);
};
/*************************************************/
...
* }
**************************************************/
std::string ARK::API::ONE_Delegates::delegateForgedByAccount(
		const char *const generatorPublicKey
) {
	char uri[152 + 1];
		strcpy(uri, ARK::API::ONE_Paths::ONE_Delegates::getForgedByAccount_s);
...
* }
**************************************************/
std::string ARK::API::ONE_Delegates::delegateNextForgers()
{
	return netConnector.callback(ARK::API::ONE_Paths::ONE_Delegates::getNextForgers_s);
};
/*************************************************/
